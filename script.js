...
function getRecipe(query) {
  ...
  fetch(`https://api.spoonacular.com/recipes/search?apiKey=83391e00768640b29c383a671ab06380&query=${query}`)
    .then(response => {
...
function getSource(recipeId) {
  // Fetch data from Spoonacular API
  fetch(`https://api.spoonacular.com/recipes/${recipeId}/information?apiKey=83391e00768640b29c383a671ab06380`)
    .then(response => {
      // Check if the response is ok
      if (!response.ok) {
        throw new Error('Network response was not ok');
